...
- 多本地槽位需确认按当前输入控制器选择目标，无法唯一确定时不执行。完整记录见 [主动 AFK 按钮问题记录](../issues/ISSUES-2026-09-01-新增ESC菜单主动AFK按钮.md)。
- 单人房间提示及中英文实机验收已通过，完整过程统一记录见 [主动 AFK 按钮问题记录](../issues/ISSUES-2026-09-01-新增ESC菜单主动AFK按钮.md)。
