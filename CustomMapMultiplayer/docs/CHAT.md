...
- 仅在输入框真正打开并进入编辑状态时拦截当前键盘聊天角色的操作；仅显示聊天历史和“按[ENTER]或手柄的[BACK]键聊天”提示时不拦截。
...
聊天输入框激活时的当前键盘角色操作拦截已通过用户真实键盘确认：输入框打开期间移动、跳跃、攻击、特殊动作和冲刺均不响应，关闭输入框后操作恢复，仅显示历史/提示时仍可操作。详见[聊天输入框激活时角色仍可操作](../issues/archive/ISSUES-2026-09-07-联机聊天输入框激活时角色仍可操作.md)。
...
- [中文输入法支持与关键改动](../issues/archive/ISSUES-2026-09-05-联机聊天中文输入法支持与关键改动.md)
- [长消息可视滚动效果](../issues/archive/ISSUES-2026-09-05-联机聊天输入框长消息可视滚动效果不理想.md)
- [上下方向键跨视觉行移动](../issues/archive/ISSUES-2026-09-06-联机聊天输入框上下方向键跨视觉行移动.md)
- [右下角字数显示](../issues/archive/ISSUES-2026-09-06-联机聊天输入框右下角字数显示.md)
- [长消息发送后历史显示](../issues/archive/ISSUES-2026-09-06-联机聊天长消息发送后历史显示被隐藏.md)
- [输入框激活时角色仍可操作](../issues/archive/ISSUES-2026-09-07-联机聊天输入框激活时角色仍可操作.md)
