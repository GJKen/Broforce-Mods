...
聊天输入框激活时的当前键盘角色操作拦截已通过用户真实键盘确认：输入框打开期间移动、跳跃、攻击、特殊动作和冲刺均不响应，关闭输入框后操作恢复，仅显示历史/提示时仍可操作。详见[聊天输入框激活时角色仍可操作](../issues/ISSUES-2026-09-07-联机聊天输入框激活时角色仍可操作.md)。
...
- [输入框激活时角色仍可操作](../issues/ISSUES-2026-09-07-联机聊天输入框激活时角色仍可操作.md)
