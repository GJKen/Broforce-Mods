...
namespace CustomMapMultiplayer
{
    ...
    {
        private const string HarmonyId = "GJKen.CustomMapMultiplayer.MethodTrace";
        ...
        private static readonly TraceTarget[] Targets =
        {
            ...
            new TraceTarget("CustomMapMultiplayer.FrpDirectLayer", "CreateMatch"),
            new TraceTarget("CustomMapMultiplayer.FrpDirectLayer", "JoinLobby"),
            new TraceTarget("CustomMapMultiplayer.FrpDirectLayer", "LeaveMatch"),
            ...
            HarmonyMethod spawnJoinedPlayersPostfix)
        {
            if ((target.TypeName == "SteamLayer" ||
                 target.TypeName == "CustomMapMultiplayer.FrpDirectLayer") &&
